...
if NO_VENDOR:
    find_excludes += ["pythonbasic._vendor", "pythonbasic._vendor.*"]
    py_modules += ["pythonbasic._vendor.__init__"]
else:
    package_data.update({
        "pythonbasic._vendor.certifi": ["*.pem"],
        "pythonbasic._vendor.requests": ["*.pem"],
        "pythonbasic._vendor.distlib._backport": ["sysconfig.cfg"],
        "pythonbasic._vendor.distlib": ["t32.exe", "t64.exe", "w32.exe", "w64.exe"],
    })


setup(
    name="pythonbasic",
    version=find_version("pythonbasic", "__init__.py"),
    ...
    entry_points={
        "console_scripts": [
            "pythonbasic=pythonbasic:main",
            "pythonbasic%s=pythonbasic:main" % sys.version[:1],
            "pythonbasic%s=pythonbasic:main" % sys.version[:3],
        ],
    },
